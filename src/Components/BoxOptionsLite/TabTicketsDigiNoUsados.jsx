  ...
  const cargarItemsDeBalanza = () => {
    ...
    balanza.estadoVales((res) => {
      ...
      if (res.status) {
        ...
        var noUsados52 = []
        const info51 = res.info.info51
        res.info.info52.forEach((tic) => {
          if (!balanza.yaEstaUsado(tic.nroVale)) {
            noUsados52.push(tic)
          }
        })
...
export default TabTicketsDigiNoUsados;
